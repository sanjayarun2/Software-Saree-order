...
export function OrderAlertToast() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 top-3 z-[100] flex justify-center px-4">
      <Link
        href="/orders/"
        className="pointer-events-auto max-w-md rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-3 shadow-lg dark:border-emerald-900/50 dark:bg-emerald-950/90"
      >
