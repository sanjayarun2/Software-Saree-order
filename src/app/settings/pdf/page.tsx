...
const PDF_LOGO_BOX_REDUCE_MM = 6;
const PDF_LEFT_COL_W_MM = PDF_BASE_COL_W_MM + PDF_COL_SIDE_GAIN_MM + PDF_LOGO_BOX_REDUCE_MM / 2;
const PDF_RIGHT_COL_W_MM = PDF_BASE_COL_W_MM + PDF_COL_SIDE_GAIN_MM + PDF_LOGO_BOX_REDUCE_MM / 2;
const PDF_CENTER_COL_W_MM = PDF_BASE_COL_W_MM - PDF_COL_SIDE_GAIN_MM * 2 - PDF_LOGO_BOX_REDUCE_MM;
...
const PDF_LOGO_BOX_MM = PDF_CENTER_COL_W_MM; // must match LOGO_MAX_W_MM / LOGO_MAX_H_MM in pdf-utils.ts
